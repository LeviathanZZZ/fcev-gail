...
%pkg load io
Eff_init = Mot.efficiency_table; % 计算的效率
Torque_init = Mot.T_eff_bp;     % 转矩
...
pcolor(Mot.w_eff_bp,Torque_init,Eff_init);                                                         %填充等高线之间的空隙
shading interp;hold on;colorbar;

[C,H]=contour(Mot.w_eff_bp,Torque_init,Eff_init,range,'ShowText','on','color','k','LineWidth', 1); %这里20调整线的等级
A=xlabel('Speed, [rpm]');
B=ylabel('Torque, [Nm]');
