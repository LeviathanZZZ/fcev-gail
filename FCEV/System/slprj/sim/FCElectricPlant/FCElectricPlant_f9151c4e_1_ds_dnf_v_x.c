...
#include "FCElectricPlant_f9151c4e_1_ds_dnf_v_x.h"
...
int32_T FCElectricPlant_f9151c4e_1_ds_dnf_v_x ( const NeDynamicSystem * LC ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 394 ] = { true , true , true , true , true , true , true , true
...
true , true , true , true , true , false , true , true , true , true , true ,
true , true , true , true , true , false , true , false , false , true ,
false , false , true , true , true , false } ; PmBoolVector out ; int32_T b ;
boolean_T t0 [ 394 ] ; ( void ) t1 ; ( void ) LC ; out = t2 -> mDNF_V_X ; for
( b = 0 ; b < 394 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b
< 394 ; b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void ) LC ; ( void ) t2 ;
return 0 ; }
