...
_cg_const_1 [ 399 ] = { true , true , true , true , true , true , true , true
...
false } ; PmBoolVector out ; int32_T b ; boolean_T t0 [ 399 ] ; ( void ) t1 ;
( void ) LC ; out = t2 -> mDNF_V_X ; for ( b = 0 ; b < 399 ; b ++ ) { t0 [ b
] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 399 ; b ++ ) { out . mX [ b ] =
