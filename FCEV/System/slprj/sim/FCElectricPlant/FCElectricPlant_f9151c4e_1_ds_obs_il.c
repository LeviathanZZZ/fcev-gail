...
_cg_const_1 [ 1885 ] = { true , true , true , true , true , true , true ,
...
int32_T b ; boolean_T t0 [ 1885 ] ; ( void ) t1 ; ( void ) LC ; out = t2 ->
mOBS_IL ; for ( b = 0 ; b < 1885 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; }
for ( b = 0 ; b < 1885 ; b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void ) LC ;
( void ) t2 ; return 0 ; }
