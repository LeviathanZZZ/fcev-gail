...
_cg_const_1 [ 1709 ] = { true , false , false , false , false , false , true
...
int32_T b ; boolean_T t0 [ 1709 ] ; ( void ) t1 ; ( void ) LC ; out = t2 ->
mOBS_IL ; for ( b = 0 ; b < 1709 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; }
for ( b = 0 ; b < 1709 ; b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void ) LC ;
( void ) t2 ; return 0 ; }
