...
_cg_const_1 [ 394 ] = { false , false , false , false , false , true , true ,
...
, true , true , true , true , true , true , true , true , true , true , true
, true , true , false , true , true , true , true , true , true , true , true
, true , false } ; PmBoolVector out ; int32_T b ; boolean_T t0 [ 394 ] ; (
void ) t1 ; ( void ) LC ; out = t2 -> mVMF ; for ( b = 0 ; b < 394 ; b ++ ) {
t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 394 ; b ++ ) { out . mX [
