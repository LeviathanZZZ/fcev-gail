...
16 ] ; real_T myssjwdee1 [ 24 ] ; } lc2agjjnwf ; typedef struct { int8_T
k3j1amkab5 ; } oecdflrzti ; typedef struct { real_T mjdk2hab1e ; } fqp5ibbznb
; typedef struct { boolean_T jrdv3hmnoc ; int8_T d3vznomj0x ; } oizox0twh0 ;
typedef struct { int8_T lim0ml1jqw ; } benvcf5o21 ; typedef struct { real_T
ewkfjng1l4 ; real_T hcmrnlatk5 ; real_T mwz5tssn5o ; real_T exbq33mn51 ;
real_T dgykadrj5y ; real_T aereisbden ; } ejajaq4sjj ; typedef struct {
int8_T iojd2jlc3k ; } ibb22rhdhi ; typedef struct { real_T cxk3fsuqri ; }
ezr503rgsr ; typedef struct { real_T cxk3fsuqri ; } ocyn02au15 ; typedef
struct { boolean_T cxk3fsuqri ; } kyr1rhkn5p ; typedef struct { real_T
...
struct { kyr1rhkn5p ndg43gdj2cy ; } oj3qcikvsd ; typedef struct { asw3ocj4en
ndg43gdj2cy ; } jsyfghzlbs ; typedef struct { lps5fweizp ndg43gdj2cy ; }
kckfzckqe5 ; typedef struct { amel0smx4y ndg43gdj2cy ; } kgdb5tut5v ; typedef
struct { real_T bzjc1unozv ; dmpx2jc2pu fate2u2iog ; } avaxmyit3j ; typedef
...
typedef struct { kyr1rhkn5p fkdt002bwx ; } mngph55n5r ; typedef struct {
asw3ocj4en fkdt002bwx ; } hwisdnpky5 ; typedef struct { lps5fweizp fkdt002bwx
; } fptwlttveg ; typedef struct { amel0smx4y fkdt002bwx ; } cekzt1rnxr ;
typedef struct { real_T iztgeaiw2b ; gzahetipq4 fd4qjwy5lm ; } lgsc2euz0b ;
typedef struct { epqdxq1edn fd4qjwy5lm ; } nxa00c0sli ; typedef struct {
jipem2r5u4 fd4qjwy5lm ; } ave4ahp3br ; typedef struct { fvwoypcxq5 fd4qjwy5lm
; } pwcyz0zv0a ; typedef struct { mngph55n5r fd4qjwy5lm ; } fooqmswbbc ;
typedef struct { hwisdnpky5 fd4qjwy5lm ; } niajceetmc ; typedef struct {
fptwlttveg fd4qjwy5lm ; } aeu2unkift ; typedef struct { cekzt1rnxr fd4qjwy5lm
; } dlgnmjtuzs ; typedef struct { real_T kn3kq1dbud [ 3 ] ; real_T if3fq2sidt
[ 2 ] ; real_T b1gikpnzh3 ; real_T n1fith1shx ; real_T bq4m0yykga ; real_T
oac32d025c ; real_T h35rll4cn4 ; real_T gzmaney24b ; real_T jk3qveh3bd ;
real_T a0hsqpxz3b ; real_T nlkcdzukvl ; real_T gsrk5elwxp [ 2 ] ; real_T
ltgafk04fm [ 2 ] ; real_T bhoakmd05s ; real_T mlyerx0zo2 ; real_T o5qnqtv4rr
; real_T b5gfnja0pu ; real_T a454anbfuk ; real_T osvj5d1pkv ; real_T
apaluifwyb ; real_T cerbjdl0lv ; real_T kqttujkp5i [ 3 ] ; real_T a1lc0bzspv
[ 3 ] ; real_T eq4bvclop4 [ 3 ] ; real_T ck4qnpyfku ; real_T kbmx45xxxk ;
real_T otssvk1ntn ; real_T c2um2c3fzr ; real_T pr2530cved ; real_T o21hp01df2
; real_T pmhtxeb5od [ 2 ] ; real_T boxmszjlz1 ; real_T evq31jzljx ; real_T
g3qrjs4pvm ; real_T kms3o3yk0z ; real_T cpxmevd5ln [ 12 ] ; real_T k4h2lncslm
[ 2 ] ; lgsc2euz0b eblhn1q21v [ 1 ] ; lc2agjjnwf cl0311alh3 ; avaxmyit3j
nod5vp1cyy [ 1 ] ; lc2agjjnwf f0qvxxi2xz ; gqcilb1ome izrftnejci [ 4 ] ; }
pw4f2kjo3k ; typedef struct { real_T jdfraz14md ; real_T jrm4ykfn0y ; int_T
...
real_T P_158 ; real_T P_159 [ 34 ] ; real_T P_160 [ 3 ] ; real_T P_161 [ 3 ]
; real_T P_162 [ 9 ] ; real_T P_163 ; real_T P_164 ; real_T P_165 ; real_T
P_166 ; real_T P_167 ; real_T P_168 ; real_T P_169 ; real_T P_170 ; real_T
P_171 ; real_T P_172 [ 3 ] ; real_T P_173 [ 3 ] ; real_T P_174 [ 9 ] ; real_T
...
P_205 ; real_T P_206 ; real_T P_207 ; real_T P_208 [ 34 ] ; real_T P_209 [ 3
] ; real_T P_210 [ 3 ] ; real_T P_211 [ 9 ] ; real_T P_212 ; real_T P_213 ;
real_T P_214 ; real_T P_215 ; real_T P_216 ; real_T P_217 ; real_T P_218 ;
real_T P_219 ; real_T P_220 ; real_T P_221 [ 3 ] ; real_T P_222 [ 3 ] ;
real_T P_223 [ 9 ] ; real_T P_224 ; real_T P_225 ; real_T P_226 ; real_T
...
P_262 ; real_T P_263 ; real_T P_264 ; real_T P_265 ; real_T P_266 ;
lu0k1fvhhc eblhn1q21v ; gwbuyqty4q nod5vp1cyy ; fu2d21p2me izrftnejci ; } ;
...
14 ] ; RTWLoggingFcnPtr loggingPtrs [ 14 ] ; sysRanDType * systemRan [ 25 ] ;
...
d3jy5zi252 , real_T fg54spf2n5 , real_T * j1fnstwyfj , real_T * ihdfu1wy5f ,
real_T * nsspl2j5q4 , real_T * krssuruyhs , real_T * j4xjl2dd0q , real_T
rtp_FZMAX , real_T rtp_FZMIN , real_T rtp_VXLOW , real_T rtp_kappamax ,
lc2agjjnwf * localB ) ; extern void kk0gqeonff ( boolean_T * grd1lflkc0 ,
k15rssna2x * localP ) ; extern void bl2yl1izeh ( boolean_T * grd1lflkc0 ) ;
extern void lx5pzbjgnj ( real_T ay3xeuearj , real_T dotxz5qshb , boolean_T *
grd1lflkc0 , oecdflrzti * localDW ) ; extern void fvcqjct50p ( boolean_T *
j1l0ikyczw , oizox0twh0 * localDW , p4tcmhlmqo * localP ) ; extern void
lqozigtnao ( boolean_T * j1l0ikyczw , fqp5ibbznb * localB ) ; extern void
jkqilwbv4l ( real_T deauqq3iqo , real_T aggo5m10cn , boolean_T * j1l0ikyczw ,
fqp5ibbznb * localB , oizox0twh0 * localDW , p4tcmhlmqo * localP ) ; extern
void jkqilwbv4lTID2 ( real_T rtp_br , fqp5ibbznb * localB , p4tcmhlmqo *
localP ) ; extern void mbjlcj4mlk ( hcopmldpph * const a5ree4wwe5 ) ; extern
void ehvsb4g243 ( real_T * jk5v2hweet , real_T * mfovcxxqab , real_T *
jilotr4g4q , real_T * m4inimtjpw ) ; extern void oxojvdus0j ( hcopmldpph *
const a5ree4wwe5 ) ; extern void hpjac0modf ( hcopmldpph * const a5ree4wwe5 ,
...
, ezr503rgsr * localX ) ; extern void fhk5xmrghf ( real_T * pwdllqgo55 ,
real_T * evp41woadu , real_T * kqgisutphd , real_T * lgy4zlekl2 , real_T
rtp_omegao , dmpx2jc2pu * localB , fmdhv4fck3 * localDW , pymb3fi5g4 * localP
, bobjql0acy * localX ) ; extern void hjtn2cfetd ( real_T * pwdllqgo55 ,
real_T * evp41woadu , real_T * kqgisutphd , real_T * lgy4zlekl2 , fmdhv4fck3
* localDW , bobjql0acy * localX ) ; extern void jzxqghlsdl ( real_T *
pwdllqgo55 , real_T * evp41woadu , real_T * kqgisutphd , real_T * lgy4zlekl2
, dmpx2jc2pu * localB ) ; extern void blmwtgrkjm ( dmpx2jc2pu * localB ,
fmdhv4fck3 * localDW , pjvirltsck * localXdot ) ; extern void cddyh02qci (
hcopmldpph * const a5ree4wwe5 , real_T fgvs5banyw , real_T auareadgka ,
real_T ka4js1rmku , real_T * pwdllqgo55 , real_T * evp41woadu , real_T *
kqgisutphd , real_T * lgy4zlekl2 , real_T rtp_omegao , real_T rtp_br , real_T
rtp_Iyy , real_T rtp_OmegaTol , dmpx2jc2pu * localB , fmdhv4fck3 * localDW ,
pymb3fi5g4 * localP , bobjql0acy * localX , oj3qcikvsd * localXdis ) ; extern
void cddyh02qciTID2 ( real_T rtp_br , dmpx2jc2pu * localB , pymb3fi5g4 *
localP ) ; extern void efyr52spdx ( real_T * ckea2phy4a , real_T * mbdwegsgqk
, real_T * akcvyr55kg , real_T * khmbidmlxe , real_T rtp_omegao , gzahetipq4
* localB , epqdxq1edn * localDW , eyoob242x4 * localP , jipem2r5u4 * localX )
; extern void gkwx1uvgy3 ( real_T * ckea2phy4a , real_T * mbdwegsgqk , real_T
* akcvyr55kg , real_T * khmbidmlxe , epqdxq1edn * localDW , jipem2r5u4 *
localX ) ; extern void p3l4kwjfse ( real_T * ckea2phy4a , real_T * mbdwegsgqk
, real_T * akcvyr55kg , real_T * khmbidmlxe , gzahetipq4 * localB ) ; extern
void dq1cbs3e5h ( gzahetipq4 * localB , epqdxq1edn * localDW , fvwoypcxq5 *
localXdot ) ; extern void b5prwuabwt ( hcopmldpph * const a5ree4wwe5 , real_T
kx4svy31tg , real_T br5yrlp4to , real_T dq54xdamlz , real_T * ckea2phy4a ,
real_T * mbdwegsgqk , real_T * akcvyr55kg , real_T * khmbidmlxe , real_T
rtp_omegao , real_T rtp_br , real_T rtp_Iyy , real_T rtp_OmegaTol ,
gzahetipq4 * localB , epqdxq1edn * localDW , eyoob242x4 * localP , jipem2r5u4
* localX , mngph55n5r * localXdis ) ; extern void b5prwuabwtTID2 ( real_T
rtp_br , gzahetipq4 * localB , eyoob242x4 * localP ) ; extern void eqyc2wn3m1
( hcopmldpph * const a5ree4wwe5 , pw4f2kjo3k * localB , lvsoqlxlcs * localDW
, edp3webv0p * localX ) ; extern void er1nyhy4k5 ( hcopmldpph * const
...
bbuzvmnhsa * localXdis ) ; extern void DrivetrainEvTID2 ( pw4f2kjo3k * localB
) ; extern void ekywbf3nku ( hcopmldpph * const a5ree4wwe5 ) ;
#endif
