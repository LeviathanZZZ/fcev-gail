...
MODEL                   = FCEvReferenceApplication
MODULES                 = rt_logging.c FCEvReferenceApplication.c FCEvReferenceApplication_data.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\FCEvReferenceApplication.exe
...
S_FUNCTIONS_LIB         = $(START_DIR)\slprj\rsim\_sharedutils\rtwshared.lib
NUMST                   = 5
NCSTATES                = 528
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="E:\\MATLAB_R2022b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DNRT -DRSIM_WITH_SL_SOLVER -DRSIM_PARAMETER_LOADING -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
CLASSIC_INTERFACE       = 1
MODELREFS               = FCEvPowertrainController DrivetrainEv FCElectricPlant 
TARGET_LANG_EXT         = c
SHRLIBTARGET            = 0
...
SYSTEM_LIBS             = /LIBPATH:"E:\MATLAB_R2022b\extern\lib\win64\microsoft" libmat.lib libmx.lib libut.lib libmwsl_fileio.lib libmwsl_simtarget_instrumentation.lib libmwi18n.lib libmwsigstream.lib libmwsl_AsyncioQueue.lib sf_runtime.lib libmwsl_solver_rtw.lib
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = D:\FCEV_GAIl\FCEV\Work\slprj\rsim\DrivetrainEv\DrivetrainEv_rtwlib.lib D:\FCEV_GAIl\FCEV\Work\slprj\rsim\FCElectricPlant\FCElectricPlant_rtwlib.lib D:\FCEV_GAIl\FCEV\Work\slprj\rsim\FCEvPowertrainController\FCEvPowertrainController_rtwlib.lib
