...
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_10_5 = ( real_T * )
...
slmrInitializeIOPortDataVectors ( S , 9 , 6 ) ; if ( ! ssSetNumInputPorts ( S
, 9 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return
...
ssSetInputPortOffsetTime ( S , 8 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 6
