...
int32_T FCElectricPlant_66b3e3da_1_ds_obs_il ( const NeDynamicSystem * LC ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 200 ] = { true , true , true , true , true , true , true , true
...
, true , true , true , false , false , true , true } ; PmBoolVector out ;
int32_T b ; boolean_T t0 [ 200 ] ; ( void ) t1 ; ( void ) LC ; out = t2 ->
mOBS_IL ; for ( b = 0 ; b < 200 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; }
for ( b = 0 ; b < 200 ; b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void ) LC ;
( void ) t2 ; return 0 ; }
