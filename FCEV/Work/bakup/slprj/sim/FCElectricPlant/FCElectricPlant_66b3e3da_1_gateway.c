...
FCElectricPlant_66b3e3da_1_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group ( "FCElectricPlant/Solver Configuration_1" , 1
