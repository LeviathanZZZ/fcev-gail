...
ssGetInputPortSignal ( S , 3 ) ; real_T * o_B_19_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_19_2 = ( real_T * )
...
) , i_ohqozwr3bt , i_m5lcvgivpn , i_fp2cs4ko5p , i_pldc422xqt , o_B_19_1 ,
o_B_19_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , & ( dw -> rtzce ) ,
localXdis ) ; ekz3w3o33e ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; } } static
void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn
...
ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 20 ) ;
...
i_m5lcvgivpn , i_fp2cs4ko5p , i_pldc422xqt , o_B_19_1 , o_B_19_2 , & ( dw ->
