...
_cg_const_1 [ 399 ] = { false , false , false , false , false , false , true
...
PmBoolVector out ; int32_T b ; boolean_T t0 [ 399 ] ; ( void ) t1 ; ( void )
LC ; out = t2 -> mNLDV ; for ( b = 0 ; b < 399 ; b ++ ) { t0 [ b ] =
_cg_const_1 [ b ] ; } for ( b = 0 ; b < 399 ; b ++ ) { out . mX [ b ] = t0 [
