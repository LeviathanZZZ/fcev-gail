...
#include "FCElectricPlant_f9151c4e_1_ds_nldv.h"
...
int32_T FCElectricPlant_f9151c4e_1_ds_nldv ( const NeDynamicSystem * LC ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 440 ] = { false , false , false , false , false , false , true
...
( void ) LC ; out = t2 -> mNLDV ; for ( b = 0 ; b < 440 ; b ++ ) { t0 [ b ] =
_cg_const_1 [ b ] ; } for ( b = 0 ; b < 440 ; b ++ ) { out . mX [ b ] = t0 [
