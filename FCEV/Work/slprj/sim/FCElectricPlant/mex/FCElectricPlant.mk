...
MODULES                 = FCElectricPlant_msf.c c_mexapi_version.c
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:FCElectricPlant_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELREF_LINK_LIBS        = D:\FCEV_GAIl\FCEV\Work\slprj\sim\FCElectricPlant\FCElectricPlantlib.lib
...
FCElectricPlant_msf.obj : $(START_DIR)\slprj\sim\FCElectricPlant\FCElectricPlant_msf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\sim\FCElectricPlant\FCElectricPlant_msf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\FCElectricPlant\FCElectricPlant_msf.c
