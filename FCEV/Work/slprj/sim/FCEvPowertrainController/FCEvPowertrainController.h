...
#include <stddef.h>
typedef struct { real_T gjlfkduml1 ; real_T ei3fjourx3 ; real_T orl04cgsvu ;
boolean_T enq0lu0kuo ; boolean_T aqhdwhq12l ; } izbd5cj1yx ; typedef struct {
boolean_T jf40w34zmi ; boolean_T pzummf0301 ; boolean_T c23dliamkh ; }
kfczeuvxuu ; typedef struct { real_T bzjnqqh5ry ; } ax0myfw24a ; typedef
struct { real_T bzjnqqh5ry ; } ibikp0pgia ; typedef struct { boolean_T
bzjnqqh5ry ; } d1pwx2baxm ; typedef struct { real_T bzjnqqh5ry ; } dbmyxo2m5d
; typedef struct { real_T bzjnqqh5ry ; } gf5wxrzqsr ; typedef struct { real_T
bzjnqqh5ry ; } eo2g54aezf ; typedef struct { real_T atvn20tvky ; real_T
fja35wwpwg ; real_T ifj1qrjkm3 ; } bzzrkabtjr ; struct gdngfg3ibwc_ { real_T
P_0 ; real_T P_1 ; real_T P_2 ; real_T P_3 ; real_T P_4 ; real_T P_5 ; real_T
P_6 [ 12 ] ; real_T P_7 [ 12 ] ; real_T P_8 ; real_T P_9 ; real_T P_10 ;
real_T P_11 ; } ; struct ax55bwwar2 { struct SimStruct_tag * _mdlRefSfcnS ;
...
izbd5cj1yx rtb ; kfczeuvxuu rtdw ; ezkw1qrycv rtm ; } dif03hcjvgl ; extern
void k2oudzyk03 ( SimStruct * _mdlRefSfcnS , ssNonContDerivSigFeedingOutports
...
extern void jt0nw0i3cw ( const real_T * ofofgt3fsm , ax0myfw24a * localX ,
ibikp0pgia * localXdot ) ; extern void bkxy2vuq3d ( const real_T * lqeaxkgw5f
, izbd5cj1yx * localB , bzzrkabtjr * localZCSV ) ; extern void otjhyqv5ki (
void ) ; extern void FCEvPowertrainController ( ezkw1qrycv * const jxp0bqrs0w
, const real_T * jfbc5gabq5 , const real_T * ofofgt3fsm , const real_T *
lqeaxkgw5f , real_T * hvl41qwm3c , real_T * g0hb2yo1wf , real_T * pv3jch0rpi
, izbd5cj1yx * localB , kfczeuvxuu * localDW , ax0myfw24a * localX ) ; extern
void bsdghwadnz ( ezkw1qrycv * const jxp0bqrs0w ) ;
#endif
