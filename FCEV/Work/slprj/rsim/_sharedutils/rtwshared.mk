...
MODEL                   = rtwshared
MODULES                 = automldiffopen_RcYoMae5.c interp2_gQgEamix.c look1_binlcpw.c look1_binlxpw.c rtGetInf.c rtGetNaN.c rt_atan2d_snf.c rt_nonfinite.c rt_powd_snf.c rt_zcfcn.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c look1_binlcapw.c look2_binlcapw.c log2_tqJQ4MCN.c look1_pbinlcapw.c norm_7x8GXtWF.c recomputeBlockDiag_NxbsuIUb.c rt_hypotd_snf.c rt_modd_snf.c xhseqr_f1Jkm75w.c
...
NUMST                   = 
NCSTATES                = 0
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="E:\\MATLAB_R2022b" RSIM_PARAMETER_LOADING=0 OPTS="-DNRT -DRSIM_WITH_SL_SOLVER -DRSIM_PARAMETER_LOADING"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
