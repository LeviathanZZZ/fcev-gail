...
#include "FCElectricPlant_66b3e3da_1_ds_nldv.h"
...
int32_T FCElectricPlant_66b3e3da_1_ds_nldv(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *t2)
{
  static boolean_T _cg_const_1[480] = { false, false, false, false, false, false,
