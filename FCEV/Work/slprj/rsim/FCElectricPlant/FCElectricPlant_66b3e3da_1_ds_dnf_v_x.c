...
#include "FCElectricPlant_66b3e3da_1_ds_dnf_v_x.h"
...
int32_T FCElectricPlant_66b3e3da_1_ds_dnf_v_x(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *t2)
{
  static boolean_T _cg_const_1[480] = { true, true, true, true, true, true, true,
