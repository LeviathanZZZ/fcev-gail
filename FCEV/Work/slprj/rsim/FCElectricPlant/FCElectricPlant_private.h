...
#define rt_VALIDATE_MEMORY(S, ptr)     if(!(ptr)) {\
 ssSetErrorStatus(FCElectricPlant_M->rtS, RT_MEMORY_ALLOCATION_ERROR);\
 }
#endif
...
extern P_FCElectricPlant_T FCElectricPlant_P;

#endif                               /* RTW_HEADER_FCElectricPlant_private_h_ */
